        ...
        <div className="brand-logo" >
          <Link to="/">
            <b className="logo-abbr">
              <img src="/images/logo-mini.png" style={{ position: "relative", right: "7px", width: "auto", height: "100%" }} alt="" className='img-fluid' />
            </b>
            ...
            <ul className="clearfix">
              ...
              <li class="icons dropdown" >
                <div class="user-img c-pointer position-relative" data-toggle="dropdown">
                  ...
                  <img src="/images/logo-mini.png" style={{backgroundColor:"white",paddingRight:'3px'}} height="40" width="40" alt="" />
                </div>
